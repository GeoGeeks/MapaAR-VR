...
Carousel = function (_React$Component) {_inherits(Carousel, _React$Component);
    ...
    function Carousel(props) {_classCallCheck(this, Carousel);var _this = _possibleConstructorReturn(this, (Carousel.__proto__ || Object.getPrototypeOf(Carousel)).call(this,
        ...
        _this.leftClick = _this.moveLeft.bind(_this);return _this;
    }_createClass(Carousel, [{ key: 'generateItems', value: function generateItems()
        ...
        } }, { key: 'moveRight', value: function moveRight()
        ...
        } }]);return Carousel;}(React.Component);var


Item = function (_React$Component2) {_inherits(Item, _React$Component2);

    function Item(props) {_classCallCheck(this, Item);var _this2 = _possibleConstructorReturn(this, (Item.__proto__ || Object.getPrototypeOf(Item)).call(this,
        props));
        _this2.state = {
            level: _this2.props.level };return _this2;

    }_createClass(Item, [{ key: 'render', value: function render()
